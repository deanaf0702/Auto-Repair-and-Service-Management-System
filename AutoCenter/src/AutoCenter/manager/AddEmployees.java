...
public class AddEmployees implements Interface {
    ...
    public void displayDirection() {
        System.out.println(
                "## Enter the information in the order as shown below with the delimiter `;`");
        System.out.println(
                "## Ex:423186759;Ellie;Clark;eclark;clark;3125 Avent Ferry Road, Raleigh, NC"
                        + " 27605;eclark@gmail.com;9892180921;mechanic;11-JUN-2022;30.99 ##");
