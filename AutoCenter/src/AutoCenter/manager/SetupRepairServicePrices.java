...
public class SetupRepairServicePrices implements Interface {
  ...
  public void display() {
    System.out.println("######################################");
    System.out.println("#####    Manager: Setup Repair   #####");
  ...
  public void displayDirection() {
    ...
    System.out.println(
        "## Ex:20.00, 35.99, 55.99, 12.00, 55.56, 120.55, 256.99, 100.00, 35.00, 100.99, 120.66,"
            + " 40.99 ##");
    System.out.println(
        "## Enter the information in the order as shown above with the delimiter ‘,’");
  }
  ...
  public void save() {
    String query =
        "Insert into ServicePricedByManf (serviceId, centerId, vehicleManfId, price) values(?, ?,"
            + " ?, ?)";
