...
public class UserService {
  ...
  public User authenticateEmployee(String userId, String password) {
    ...
    String query =
        "SELECT e.employeeId, e.firstName, e.lastName, e.roleType, e.centerId"
    ...
    try {
      ...
      if (rs == null) user = authenticateCustomer(userId, password);
      else {
        while (rs.next()) {
          user = new User();
  ...
  public User authenticateManager(String userId, String password) {
    ...
    // return administrator, manager, receptionist, mechanic or customer
    String query =
        "SELECT m.managerId, m.firstName, m.lastName, m.roleType, s.centerId"
  ...
  public boolean addEmployee(Employee employee) {
    ...
    if (!(repoService.validateMinAndMaxWage(employee.salaryOrWage))) return false;
