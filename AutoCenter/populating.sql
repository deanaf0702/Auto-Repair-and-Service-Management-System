...
insert into Services values (101, 'Belt Replacement', 'Repair');
insert into Services values (102, 'Engine Repair', 'Repair');
insert into Services values (103, 'Exhaust Repair', 'Repair');
insert into Services values (104, 'Muffler Repair', 'Repair');
insert into Services values (105, 'Alternator Repair', 'Repair');
insert into Services values (106, 'Power Lock Repair', 'Repair');
insert into Services values (107, 'Axle Repair', 'Repair');
insert into Services values (108, 'Brake Repair', 'Repair');
insert into Services values (109, 'Tire Balancing', 'Repair');
insert into Services values (110, 'Wheel Alignment', 'Repair');
insert into Services values (111, 'Compressor Repair', 'Repair');
insert into Services values (112, 'Evaporator Repair', 'Repair');
insert into Services values (113, 'A', 'Maintenance');
insert into Services values (114, 'B', 'Maintenance');
insert into Services values (115, 'C', 'Maintenance');
